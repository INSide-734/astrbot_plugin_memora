...
| [记忆生命周期](/reference/configuration/lifecycle) | `quality.gate`、`memory_evolution`、`topic_segmentation`、`atom_quality_filter`、`forgetting_agent` 等 | 写入门禁、演化、分割、质量、衰减、压缩和遗忘。 |
