...
import { GlobalUpdateDialog } from "@/components/system/GlobalUpdateDialog";
...
// 懒加载页面依赖（如 GraphPage 的 @antv/g6、MemoryPage 的
// @tanstack/react-virtual），仅在用户访问对应页面时下载，控制入口包体积。
