...
`/lmem status`、`/lmem health`、`/lmem diagnostics`、`/lmem search <query>`、`/lmem trace <query> [k]`、`/lmem forget <id>`、`/lmem rebuild-index`、`/lmem rebuild-graph`、`/lmem webui`、`/lmem summarize`、`/lmem reset`、`/lmem cleanup`、`/lmem update [check|download|apply]`、`/lmem help`。
