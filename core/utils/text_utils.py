...
_KNOWLEDGE_STOPWORDS: frozenset[str] = frozenset({
    ...
    "只是", "已经", "因为", "所以", "但是", "如果", "虽然", "而且",
    "或者", "不过", "然后", "最后", "之后", "以前", "以后", "时候",
    "知道", "觉得", "认为", "应该", "可能", "需要", "能够", "希望",
    ...
    "about", "up", "out", "if", "but", "or", "not", "and", "this", "that",
    "it", "its", "they", "them", "their", "we", "us", "our", "you", "your",
    "he", "she", "him", "her", "his", "my", "me", "no", "nor", "which",
    "who", "whom", "what", "isn", "aren", "wasn", "weren", "hasn", "haven",
    "hadn", "doesn", "don", "didn", "won", "wouldn", "shan", "shouldn",
    "can", "couldn", "mustn", "let", "re", "ve", "ll", "d", "s", "t",
})
