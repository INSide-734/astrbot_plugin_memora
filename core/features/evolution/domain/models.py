...
class MemoryProjectionProposal:
    ...
    def __post_init__(self) -> None:
        """规范 projection 类型和来源 alias，并校验内容边界。"""
...
class EvolutionSignal:
    ...
    def source(self) -> MemorySourceRef:
        ...
        Returns:
            保留 ID、revision、scope、privacy 和发生时间的来源引用。

        Raises:
            ValueError: 信号缺少构造来源引用所需的发生时间。
        """
...
class ProjectionView:
    ...
    def __post_init__(self) -> None:
        """规范 projection 读模型并校验来源、隐私和时间证据。"""
...
class DerivedApplyPlan:
    ...
    def __post_init__(self) -> None:
        """冻结派生应用计划并复制 source revision 映射。"""
