...
if TYPE_CHECKING:
    from ..infrastructure.debug_reporter import (
...
def monitored(func: _F) -> _F:
    ...
    def resolve_instrumented() -> _F:
        ...
        if instrumented_func is None:
            from ..infrastructure.instrumentation import monitored as instrument
...
def reset_trace_context() -> None:
    ...
    if not _runtime_debug_enabled:
        return
    from ..infrastructure.instrumentation import reset_trace_context as reset
...
def set_debug_mode(
    ...
    *,
    ...
    from ..infrastructure.debug_reporter import configure_debug_reporting
    ...
    if enabled:
        from ..infrastructure.instrumentation import set_debug_mode as _set_debug
...
def __getattr__(name: str) -> Any:
    ...
    if name in {
        ...
        from ..infrastructure import debug_reporter as _reporter
