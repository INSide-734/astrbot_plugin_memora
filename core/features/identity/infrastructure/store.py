...
async def apply_identity_store_pragmas(connection: aiosqlite.Connection) -> None:
    """为身份目录连接应用固定的 SQLite 一致性与性能设置。"""
...
class ProtocolIdentityStore:
    ...
    async def initialize(self) -> None:
        ...
        await apply_identity_store_pragmas(connection)
