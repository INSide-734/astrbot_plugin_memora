...
def test_diagnostic_endpoints_keep_admin_permission_decorators() -> None:
    ...
    for command in ("health", "diagnostics", "trace"):
        ...
        previous_command_index = source.rfind("@lmem.command(", 0, command_index)
